...
def home_screen():
    ...
    def signin():
        ...
        if result:
            ...
            bmi_wd.geometry("450x644+300+200")
            ...
            def BMI():
                ...
                Label1.config(text=bmi).place(x=200,y=330)
                if bmi < 18.5:
            ...
            label=Label(bmi_wd,text="Height",fg='black',bg='white',font=('Helvetica',28))
            label.place(x=66,y=105)
            
            Label(bmi_wd,image=box).place(x=240,y=100)
            label=Label(bmi_wd,text="Weight",fg='black',bg='white',font=('Helvetica',28))
            label.place(x=285,y=105)
            #scale 
            Scale=PhotoImage(file="scale.png")
            Label(bmi_wd,image=Scale,bg="Lightblue").place(x=20,y=380)
            ##################slider1##################################################
            ...
            def slider_changed(event):
                ...
                secondimage.place(x=70,y=620-size)
            ...
            Button(bmi_wd,text="View Report",width=15,height=2,font="arial 10 bold",bg="#1f6e68",fg="white",command=BMI).place(x=280,y=390)
            ...
            Button(bmi_wd,text="Get help",width=15,height=2,font="arial 10 bold",bg="#1f6e68",fg="white",command=redirect).place(x=280,y=550)
    ...
    label1=Label(frame,text="Sign in with otp",fg='black',bg='white',font=('Microsoft YaHei UI Light',9))
